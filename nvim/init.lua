...
vim.keymap.set('n', '<leader>tt', function() Snacks.picker.todo_comments() end)
vim.keymap.set('n', '<leader>tx', ":Trouble diagnostics toggle filter.buf=0<CR>")
vim.keymap.set('n', '<leader>tX', ":Trouble diagnostics<CR>")
